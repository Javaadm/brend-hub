    ...
    307: function (t, e, r) {
        ...
        var z = function (t) {
            ...
            return Object(n.a)(r, [{
                key: "titlePretty", get: function () {
                    ...
                    return t ? this.title ? this.title : "Уже ".concat(Object(k.a)("создан|создано|создано", t), " ").concat(t, "&nbsp;").concat(Object(k.a)("бренд|бренда|брендов", t), " ").concat(this.isCategoriesEmpty ? "" : "в") : "Ещё не создано брендов в"
                }
            }, {
                ...
                key: "categoriesTotalTitle", get: function () {
                    ...
                    return e ? "".concat(e, " ").concat(Object(k.a)("сфере|сферах|сферах", e)) : ""
                }
            }, {
        ...
        var j = function (t) {
            ...
            components: {
                ...
                return {title: this.pageTitle || "Проекты"}
            }, head: function () {
                return {
                    link: [{
                        rel: "canonical",
            ...
            return r("div", {staticClass: "pt-7 pb-24 lg:py-4"}, [r("div", {staticClass: "container"}, [r("CasesSection", {
                ...
                attrs: {
                    title: "Вы можете создать бренд",
                    description: "Оставьте свои контакты и мы<br> расскажем как это сделать"
                }
            })], 1)])
        }), [], !1, null, null, null);
        e.default = component.exports;
